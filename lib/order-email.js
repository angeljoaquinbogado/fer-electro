...
<body style="margin:0;background:#f5f2eb;font-family:Arial,Helvetica,sans-serif;color:#17191d">
  <div style="max-width:640px;margin:0 auto;padding:28px 14px">
    ...
    <div style="background:#fff;border:1px solid #e5dfd5;border-top:0;border-radius:0 0 22px 22px;padding:24px">
      ...
      <div style="display:flex;justify-content:space-between;gap:14px;padding:18px 0 8px;font-size:18px">
    ...
    const response=await fetch("https://api.resend.com/emails",{
        ...
        headers:{
            ...
            "Idempotency-Key":`fer-order-confirmation-${String(order.id)}`
        },
    ...
    if(!response.ok){
        const message=String(data?.message||data?.error||"No se pudo enviar el email");
